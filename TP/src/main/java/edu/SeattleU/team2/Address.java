...
public class Address {
    ...
    public Address (String country, String recipient, String streetAddress, String postalCode, String city_town_locality, String state, String street_number) {
    ...
    Address (int ID, String country, String recipient, String streetAddress, String postalCode, String city_town_locality, String state, String street_number) {
        this.ID = ID;
        this.country = country;
        this.recipient = recipient;
        this.streetAddress = streetAddress;
